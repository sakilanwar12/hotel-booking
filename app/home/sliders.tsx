...
const Sliders = ({ data }: DataProps) => {
    ...
    return (
        <div className='relative'>
            ...
            <div className="custom-pagination mt-8 flex justify-center gap-3 [&>span]:w-3 [&>span]:h-3 [&>span]:rounded-full [&>span]:bg-primary [&>span]:transition-all [&>span]:duration-300 [&>span]:hover:bg-primary/80 [&>span]:cursor-pointer"></div>
        </div >
    );
}
